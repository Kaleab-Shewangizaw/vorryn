...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: { preventDefault(): void }) => {
    ...
    if (authError) {
      setError(authError.message || "The forge rejected your oath. Try again.");
      setLoading(false);
      return;
    }

    // New warriors go to the setup page to choose their warrior name
      ...
      <div className="relative z-20 w-full max-w-md flex flex-col items-center gap-8">
        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            />
            <span className="text-[10px] text-slate-600 font-sans tracking-wide mt-0.5">
              Minimum 8 characters. Make it worthy.
            </span>
          </div>
